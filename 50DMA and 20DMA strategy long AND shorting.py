...
df_results_short=pd.DataFrame({'Dates for closing Short positions':Record_of_dates_closing_short_trades, 'Profit/Loss for short positions $USD$':Record_of_short_deals})
df_results_long=pd.DataFrame({'Dates for closing Long positions': Record_of_dates_closing_long_trades, 'Profit/Loss for long positions $USD$':Record_of_long_deals})
print(df_results_short)
print(df_results_long)
